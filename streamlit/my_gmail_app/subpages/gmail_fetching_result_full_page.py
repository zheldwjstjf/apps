...
class GmailFetchingResultFullPage:
    ...
    def get_mail_content(self, service, user, mail_id, selected_content_info):
        ...
        try:
            ...
            # text
            self.st.info("● mail_date : "); self.st.code(mail_date)
            self.st.info("● mail_from : "); self.st.code(mail_from)
            self.st.info("● mail_to : "); self.st.code(mail_to)
            self.st.info("● mail_snippet : "); self.st.info(mail_snippet)
