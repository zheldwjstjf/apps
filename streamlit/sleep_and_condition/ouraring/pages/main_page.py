...
class MainPage:
    ...
    def main_page(self, sleep, start_date, end_date, key_word_list1, key_word_list2, key_word_list3):
        ...
        if (start_date!=None) and (end_date!=None):
            ...
            col1, col2, col3, col4, col5, col6 = self.st.columns((1,1,1,2,1,1))
            col2.write(" ▶︎ スコア")
            ...
            for key_word in key_word_list2:
                col4.write(" - " + str(key_word) + " : " + str(sleep_dict.get(key_word)/60) + " / " + str(int((sleep_dict.get(key_word)/duration)*100)) + "%")
