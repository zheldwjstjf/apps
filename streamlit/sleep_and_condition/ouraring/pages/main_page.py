...
class MainPage:
    ...
    def main_page(self, sleep, start_date, end_date, key_word_list1, key_word_list2, key_word_list3):
        ...
        if (start_date!=None) and (end_date!=None):
            ...
            col1,col2,col3,col4 = self.st.columns((1,2,1,1))
            ...
            col2.markdown("<h2 style='text-align: center; color: red;'>" + "睡眠データ : " + str(sleep_dict.get("summary_date")) + "</h2>", unsafe_allow_html=True)
