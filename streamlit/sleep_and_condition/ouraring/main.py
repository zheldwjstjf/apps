...
options1 = st.multiselect('▶︎ 項目を選択',key_word_list1, default="score")
# st.write("options : ", options1)

options2 = st.multiselect('▶︎ 項目を選択',key_word_list2, default="duration")
# st.write("options : ", options2)

options3 = st.multiselect('▶︎ 項目を選択',key_word_list3, default="temperature_deviation")
